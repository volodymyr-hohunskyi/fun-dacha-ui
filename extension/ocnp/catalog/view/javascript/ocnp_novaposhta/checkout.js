...
function OCNP_Request(name, data){
   var m_route = 'route=extension/ocnp/shipping/novaposhta.' + name;
   var m_data = data;
   var m_language = (typeof window.OC_LANGUAGE !== 'undefined') ? window.OC_LANGUAGE : (new URLSearchParams(window.location.search).get('language') || 'uk-ua');

   this.getURL = function(){
      return ('index.php?' + m_route + '&language=' + m_language);
   }
